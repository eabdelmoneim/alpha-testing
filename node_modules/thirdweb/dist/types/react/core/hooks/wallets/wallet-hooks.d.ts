 ...
 * @walletConnection
 */
export declare function useSetActiveWallet(): (wallet: Wallet) => void;
/**
...
export declare function useConnect(): {
    readonly connect: (options: Wallet | (() => Promise<Wallet>)) => Promise<Wallet | null>;
 ...
 * @walletConnection
 */
export declare function useActiveWalletConnectionStatus(): import("../../../../exports/wallets.js").ConnectionStatus;
/**
 ...
 * @internal
 */
export declare function useSetActiveWalletConnectionStatus(): (newValue: import("../../../../exports/wallets.js").ConnectionStatus) => void;
/**
