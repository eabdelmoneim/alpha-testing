import type { BlockTag, EIP1193RequestFn, EIP1474Methods, RpcTransactionRequest, Hex, RpcStateMapping } from "viem";
type StateOverride = Record<string, {
    /**
 ...
 * ```
 */
export declare function eth_call(request: EIP1193RequestFn<EIP1474Methods>, params: Partial<RpcTransactionRequest> & {
