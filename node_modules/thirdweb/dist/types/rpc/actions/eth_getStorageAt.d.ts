import type { EIP1193RequestFn, EIP1474Methods, BlockTag, Hex } from "viem";
 ...
 * ```
 */
export declare function eth_getStorageAt(request: EIP1193RequestFn<EIP1474Methods>, params: GetStorageAtParams): Promise<Hex>;
export {};
