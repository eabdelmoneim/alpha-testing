...
export type InitializeParams = Prettify<InitializeParamsInternal | {
 ...
 * ```
 */
export declare function encodeInitializeParams(options: InitializeParamsInternal): `0x${string}`;
/**
 ...
 * ```
 */
export declare function initialize(options: BaseTransactionOptions<InitializeParams>): import("../../../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
export {};
