...
export type DeployERC721ContractOptions = Prettify<ClientAndChainAndAccount & {
 ...
 * ```
 */
export declare function deployERC721Contract(options: DeployERC721ContractOptions): Promise<string>;
//# sourceMappingURL=deploy-erc721.d.ts.map