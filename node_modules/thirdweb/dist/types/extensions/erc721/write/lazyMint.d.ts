 ...
 * ```
 */
export declare function lazyMint(options: BaseTransactionOptions<LazyMintParams>): Promise<import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>>;
export {};
