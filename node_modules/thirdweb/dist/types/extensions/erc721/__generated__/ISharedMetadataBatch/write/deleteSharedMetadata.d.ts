 ...
 * ```
 */
export declare function isDeleteSharedMetadataSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeDeleteSharedMetadata(options: DeleteSharedMetadataParams): `0x1ebb2422${string}`;
/**
