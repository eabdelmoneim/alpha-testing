 ...
 * ```
 */
export declare function isOwnerOfSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOwnerOf(options: OwnerOfParams): `0x6352211e${string}`;
/**
