 ...
 * ```
 */
export declare function isTransferFromSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTransferFrom(options: TransferFromParams): `0x23b872dd${string}`;
/**
