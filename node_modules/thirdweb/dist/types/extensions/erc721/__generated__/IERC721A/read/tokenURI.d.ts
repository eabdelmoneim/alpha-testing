 ...
 * ```
 */
export declare function isTokenURISupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTokenURI(options: TokenURIParams): `0xc87b56dd${string}`;
/**
