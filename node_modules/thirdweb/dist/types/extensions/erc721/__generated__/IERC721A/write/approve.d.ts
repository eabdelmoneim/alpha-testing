 ...
 * ```
 */
export declare function isApproveSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeApprove(options: ApproveParams): `0x095ea7b3${string}`;
/**
