 ...
 * ```
 */
export declare function isMintToSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeMintTo(options: MintToParams): `0x0075a317${string}`;
/**
