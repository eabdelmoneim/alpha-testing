 ...
 * ```
 */
export declare function isEncryptDecryptSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeEncryptDecrypt(options: EncryptDecryptParams): `0xe7150322${string}`;
/**
