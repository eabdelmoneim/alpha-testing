 ...
 * ```
 */
export declare function isTokenByIndexSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTokenByIndex(options: TokenByIndexParams): `0x4f6ccce7${string}`;
/**
