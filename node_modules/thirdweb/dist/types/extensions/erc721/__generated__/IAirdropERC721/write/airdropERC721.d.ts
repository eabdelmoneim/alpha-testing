 ...
 * ```
 */
export declare function isAirdropERC721Supported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAirdropERC721(options: AirdropERC721Params): `0x7c2c059d${string}`;
/**
