 ...
 * ```
 */
export declare function isOnERC721ReceivedSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOnERC721Received(options: OnERC721ReceivedParams): `0x150b7a02${string}`;
/**
