...
export declare const SIGNED_KEY_REQUEST_VALIDATOR_EIP_712_TYPES: {
    readonly domain: {
...
export declare const SIGNED_KEY_REQUEST_METADATA_ABI: readonly [{
    ...
    readonly name: "SignedKeyRequestMetadata";
    readonly type: "tuple";
}];
