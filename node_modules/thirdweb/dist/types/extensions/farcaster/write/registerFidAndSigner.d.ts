 ...
 * ```
 */
export declare function registerFidAndSigner(options: RegisterFidAndSignerParams): import("../../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
