 ...
 * ```
 */
export declare function rentStorage(options: RentStorageParams): import("../../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
