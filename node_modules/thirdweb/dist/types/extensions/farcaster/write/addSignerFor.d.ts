 ...
 * ```
 */
export declare function addSignerFor(options: AddSignerForParams): import("../../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
