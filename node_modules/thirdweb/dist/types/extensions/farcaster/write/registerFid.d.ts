 ...
 * ```
 */
export declare function registerFid(options: RegisterFidParams): import("../../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
