 ...
 * ```
 */
export declare function isRegisterForSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRegisterFor(options: RegisterForParams): `0xa0c7529c${string}`;
/**
