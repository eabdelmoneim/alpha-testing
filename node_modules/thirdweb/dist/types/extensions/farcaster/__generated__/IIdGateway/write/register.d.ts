 ...
 * ```
 */
export declare function isRegisterSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRegister(options: RegisterParams): `0x6d705ebb${string}`;
/**
