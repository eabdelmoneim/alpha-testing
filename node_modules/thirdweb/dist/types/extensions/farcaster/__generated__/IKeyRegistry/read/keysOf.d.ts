 ...
 * ```
 */
export declare function isKeysOfSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeKeysOf(options: KeysOfParams): `0x1f64222f${string}`;
/**
