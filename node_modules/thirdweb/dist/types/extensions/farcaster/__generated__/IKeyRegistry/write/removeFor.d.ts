 ...
 * ```
 */
export declare function isRemoveForSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRemoveFor(options: RemoveForParams): `0x787bd966${string}`;
/**
