 ...
 * ```
 */
export declare function isKeyAtSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeKeyAt(options: KeyAtParams): `0x0ea9442c${string}`;
/**
