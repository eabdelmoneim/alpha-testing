 ...
 * ```
 */
export declare function isAddForSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAddFor(options: AddForParams): `0xa005d3d2${string}`;
/**
