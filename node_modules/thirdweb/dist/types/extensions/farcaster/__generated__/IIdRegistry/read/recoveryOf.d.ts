 ...
 * ```
 */
export declare function isRecoveryOfSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeRecoveryOf(options: RecoveryOfParams): `0xfa1a1b25${string}`;
/**
