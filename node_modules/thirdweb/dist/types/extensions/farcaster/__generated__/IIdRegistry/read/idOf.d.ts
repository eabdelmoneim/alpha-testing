 ...
 * ```
 */
export declare function isIdOfSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIdOf(options: IdOfParams): `0xd94fe832${string}`;
/**
