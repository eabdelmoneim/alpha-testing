 ...
 * ```
 */
export declare function isTransferForSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTransferFor(options: TransferForParams): `0x16f72842${string}`;
/**
