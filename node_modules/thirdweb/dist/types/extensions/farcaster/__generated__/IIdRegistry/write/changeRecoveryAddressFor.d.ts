 ...
 * ```
 */
export declare function isChangeRecoveryAddressForSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeChangeRecoveryAddressFor(options: ChangeRecoveryAddressForParams): `0x9cbef8dc${string}`;
/**
