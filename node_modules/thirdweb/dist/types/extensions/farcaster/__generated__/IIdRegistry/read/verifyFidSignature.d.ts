 ...
 * ```
 */
export declare function isVerifyFidSignatureSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeVerifyFidSignature(options: VerifyFidSignatureParams): `0x32faac70${string}`;
/**
