 ...
 * ```
 */
export declare function isSetRoyaltyInfoForTokenSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetRoyaltyInfoForToken(options: SetRoyaltyInfoForTokenParams): `0x9bcf7a15${string}`;
/**
