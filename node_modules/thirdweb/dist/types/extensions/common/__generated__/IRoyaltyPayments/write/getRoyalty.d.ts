 ...
 * ```
 */
export declare function isGetRoyaltySupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetRoyalty(options: GetRoyaltyParams): `0xf533b802${string}`;
/**
