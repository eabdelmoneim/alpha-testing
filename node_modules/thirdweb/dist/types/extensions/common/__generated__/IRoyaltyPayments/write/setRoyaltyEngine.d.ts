 ...
 * ```
 */
export declare function isSetRoyaltyEngineSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetRoyaltyEngine(options: SetRoyaltyEngineParams): `0x21ede032${string}`;
/**
