 ...
 * ```
 */
export declare function isMulticallSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeMulticall(options: MulticallParams): `0xac9650d8${string}`;
/**
