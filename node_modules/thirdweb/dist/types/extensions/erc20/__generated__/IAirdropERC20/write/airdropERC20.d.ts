 ...
 * ```
 */
export declare function isAirdropERC20Supported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAirdropERC20(options: AirdropERC20Params): `0x0670b2b3${string}`;
/**
