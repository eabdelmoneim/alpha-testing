 ...
 * ```
 */
export declare function isBurnFromSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBurnFrom(options: BurnFromParams): `0x79cc6790${string}`;
/**
