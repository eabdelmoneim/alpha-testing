 ...
 * ```
 */
export declare function isAllowanceSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAllowance(options: AllowanceParams): `0xdd62ed3e${string}`;
/**
