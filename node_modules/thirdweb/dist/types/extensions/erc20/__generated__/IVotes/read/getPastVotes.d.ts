 ...
 * ```
 */
export declare function isGetPastVotesSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPastVotes(options: GetPastVotesParams): `0x3a46b1a8${string}`;
/**
