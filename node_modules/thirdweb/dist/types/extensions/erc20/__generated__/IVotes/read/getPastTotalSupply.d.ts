 ...
 * ```
 */
export declare function isGetPastTotalSupplySupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPastTotalSupply(options: GetPastTotalSupplyParams): `0x8e539e8c${string}`;
/**
