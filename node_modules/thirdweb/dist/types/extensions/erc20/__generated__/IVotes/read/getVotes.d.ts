 ...
 * ```
 */
export declare function isGetVotesSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetVotes(options: GetVotesParams): `0x9ab24eb0${string}`;
/**
