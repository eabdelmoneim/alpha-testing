 ...
 * ```
 */
export declare function isPermitSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodePermit(options: PermitParams): `0xd505accf${string}`;
/**
