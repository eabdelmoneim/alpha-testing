 ...
 * ```
 */
export declare function isQuoteExactInputSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeQuoteExactInput(options: QuoteExactInputParams): `0xcdca1753${string}`;
/**
