 ...
 * ```
 */
export declare function isExactInputSingleSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeExactInputSingle(options: ExactInputSingleParams): `0x414bf389${string}`;
/**
