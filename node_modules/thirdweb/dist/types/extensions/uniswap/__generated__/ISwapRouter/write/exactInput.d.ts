 ...
 * ```
 */
export declare function isExactInputSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeExactInput(options: ExactInputParams): `0xc04b8d59${string}`;
/**
