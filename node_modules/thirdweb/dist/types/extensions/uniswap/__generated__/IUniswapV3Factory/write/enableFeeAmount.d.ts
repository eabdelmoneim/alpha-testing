 ...
 * ```
 */
export declare function isEnableFeeAmountSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeEnableFeeAmount(options: EnableFeeAmountParams): `0x8a7c195f${string}`;
/**
