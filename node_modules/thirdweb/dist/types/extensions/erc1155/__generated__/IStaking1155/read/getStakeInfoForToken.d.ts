 ...
 * ```
 */
export declare function isGetStakeInfoForTokenSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetStakeInfoForToken(options: GetStakeInfoForTokenParams): `0x168fb5c5${string}`;
/**
