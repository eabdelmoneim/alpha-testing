 ...
 * ```
 */
export declare function isGetClaimConditionByIdSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetClaimConditionById(options: GetClaimConditionByIdParams): `0xd45b28d7${string}`;
/**
