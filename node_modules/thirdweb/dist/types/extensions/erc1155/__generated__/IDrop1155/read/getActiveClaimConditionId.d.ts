 ...
 * ```
 */
export declare function isGetActiveClaimConditionIdSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetActiveClaimConditionId(options: GetActiveClaimConditionIdParams): `0x5ab063e8${string}`;
/**
