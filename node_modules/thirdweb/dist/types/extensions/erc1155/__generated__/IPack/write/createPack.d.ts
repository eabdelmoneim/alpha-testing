 ...
 * ```
 */
export declare function isCreatePackSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCreatePack(options: CreatePackParams): `0x092e6075${string}`;
/**
