 ...
 * ```
 */
export declare function isOnERC1155BatchReceivedSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOnERC1155BatchReceived(options: OnERC1155BatchReceivedParams): `0xbc197c81${string}`;
/**
