 ...
 * ```
 */
export declare function isIsApprovedForAllSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIsApprovedForAll(options: IsApprovedForAllParams): `0xe985e9c5${string}`;
/**
