 ...
 * ```
 */
export declare function isBalanceOfBatchSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBalanceOfBatch(options: BalanceOfBatchParams): `0x4e1273f4${string}`;
/**
