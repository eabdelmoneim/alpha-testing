 ...
 * ```
 */
export declare function isTotalSupplySupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeTotalSupply(options: TotalSupplyParams): `0xbd85b039${string}`;
/**
