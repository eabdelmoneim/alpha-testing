 ...
 * ```
 */
export declare function isBurnBatchSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBurnBatch(options: BurnBatchParams): `0x6b20c454${string}`;
/**
