 ...
 * ```
 */
export declare function isBurnSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBurn(options: BurnParams): `0xf5298aca${string}`;
/**
