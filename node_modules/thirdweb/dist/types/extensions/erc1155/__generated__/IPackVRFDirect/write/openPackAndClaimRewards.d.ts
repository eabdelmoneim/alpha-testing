 ...
 * ```
 */
export declare function isOpenPackAndClaimRewardsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOpenPackAndClaimRewards(options: OpenPackAndClaimRewardsParams): `0xac296b3f${string}`;
/**
