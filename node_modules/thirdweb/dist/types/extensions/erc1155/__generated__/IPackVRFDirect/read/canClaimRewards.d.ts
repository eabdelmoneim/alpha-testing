 ...
 * ```
 */
export declare function isCanClaimRewardsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCanClaimRewards(options: CanClaimRewardsParams): `0xa9b47a66${string}`;
/**
