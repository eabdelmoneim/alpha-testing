...
import { type GetActiveClaimConditionIdParams } from "../../__generated__/IDrop1155/read/getActiveClaimConditionId.js";
 ...
 * ```
 */
export declare function getActiveClaimCondition(options: BaseTransactionOptions<GetActiveClaimConditionParams>): Promise<ClaimCondition>;
