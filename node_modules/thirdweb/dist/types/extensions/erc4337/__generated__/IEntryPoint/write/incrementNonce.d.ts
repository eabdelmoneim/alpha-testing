 ...
 * ```
 */
export declare function isIncrementNonceSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIncrementNonce(options: IncrementNonceParams): `0x0bd28e3b${string}`;
/**
