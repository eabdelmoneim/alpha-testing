 ...
 * ```
 */
export declare function isHandleOpsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeHandleOps(options: HandleOpsParams): `0x1fad948c${string}`;
/**
