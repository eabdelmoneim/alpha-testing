 ...
 * ```
 */
export declare function isGetSenderAddressSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetSenderAddress(options: GetSenderAddressParams): `0x9b249f69${string}`;
/**
