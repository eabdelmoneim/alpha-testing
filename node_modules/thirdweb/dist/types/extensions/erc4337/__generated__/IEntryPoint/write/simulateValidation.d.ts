 ...
 * ```
 */
export declare function isSimulateValidationSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSimulateValidation(options: SimulateValidationParams): `0xee219423${string}`;
/**
