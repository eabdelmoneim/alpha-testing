...
export type HandleAggregatedOpsParams = Prettify<HandleAggregatedOpsParamsInternal | {
 ...
 * ```
 */
export declare function encodeHandleAggregatedOpsParams(options: HandleAggregatedOpsParamsInternal): `0x${string}`;
/**
 ...
 * ```
 */
export declare function handleAggregatedOps(options: BaseTransactionOptions<HandleAggregatedOpsParams>): import("../../../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction>;
export {};
