 ...
 * ```
 */
export declare function isHandleAggregatedOpsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeHandleAggregatedOps(options: HandleAggregatedOpsParams): `0x4b1d7cf5${string}`;
/**
