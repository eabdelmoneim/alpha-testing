 ...
 * ```
 */
export declare function isGetDepositInfoSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetDepositInfo(options: GetDepositInfoParams): `0x5287ce12${string}`;
/**
