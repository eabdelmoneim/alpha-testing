 ...
 * ```
 */
export declare function isDepositToSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeDepositTo(options: DepositToParams): `0xb760faf9${string}`;
/**
