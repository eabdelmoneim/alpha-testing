 ...
 * ```
 */
export declare function isWithdrawToSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeWithdrawTo(options: WithdrawToParams): `0x205c2878${string}`;
/**
