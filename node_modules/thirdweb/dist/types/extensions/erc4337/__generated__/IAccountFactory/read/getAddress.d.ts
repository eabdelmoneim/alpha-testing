 ...
 * ```
 */
export declare function isGetAddressSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAddress(options: GetAddressParams): `0x8878ed33${string}`;
/**
