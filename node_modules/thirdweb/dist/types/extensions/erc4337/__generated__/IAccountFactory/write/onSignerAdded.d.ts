 ...
 * ```
 */
export declare function isOnSignerAddedSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOnSignerAdded(options: OnSignerAddedParams): `0x9ddbb9d8${string}`;
/**
