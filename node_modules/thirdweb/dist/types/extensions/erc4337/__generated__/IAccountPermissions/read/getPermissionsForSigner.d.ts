 ...
 * ```
 */
export declare function isGetPermissionsForSignerSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPermissionsForSigner(options: GetPermissionsForSignerParams): `0xf15d424e${string}`;
/**
