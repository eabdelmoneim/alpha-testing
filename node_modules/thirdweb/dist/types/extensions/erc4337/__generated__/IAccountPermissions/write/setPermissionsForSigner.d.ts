 ...
 * ```
 */
export declare function isSetPermissionsForSignerSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetPermissionsForSigner(options: SetPermissionsForSignerParams): `0x5892e236${string}`;
/**
