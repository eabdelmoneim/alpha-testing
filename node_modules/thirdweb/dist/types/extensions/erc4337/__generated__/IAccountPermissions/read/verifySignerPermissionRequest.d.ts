 ...
 * ```
 */
export declare function isVerifySignerPermissionRequestSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeVerifySignerPermissionRequest(options: VerifySignerPermissionRequestParams): `0xa9082d84${string}`;
/**
