 ...
 * ```
 */
export declare function isIsActiveSignerSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIsActiveSigner(options: IsActiveSignerParams): `0x7dff5a79${string}`;
/**
