 ...
 * ```
 */
export declare function isValidateUserOpSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeValidateUserOp(options: ValidateUserOpParams): `0x3a871cdd${string}`;
/**
