 ...
 * ```
 */
export declare function isValidatePaymasterUserOpSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeValidatePaymasterUserOp(options: ValidatePaymasterUserOpParams): `0xf465c77e${string}`;
/**
