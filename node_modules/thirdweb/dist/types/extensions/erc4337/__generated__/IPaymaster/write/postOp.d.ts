 ...
 * ```
 */
export declare function isPostOpSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodePostOp(options: PostOpParams): `0xa9a23409${string}`;
/**
