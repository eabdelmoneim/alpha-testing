 ...
 * ```
 */
export declare function isIsValidSignerSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIsValidSigner(options: IsValidSignerParams): `0x523e3260${string}`;
/**
