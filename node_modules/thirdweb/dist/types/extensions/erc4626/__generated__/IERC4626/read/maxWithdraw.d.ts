 ...
 * ```
 */
export declare function isMaxWithdrawSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeMaxWithdraw(options: MaxWithdrawParams): `0xce96cb77${string}`;
/**
