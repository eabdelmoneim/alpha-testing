 ...
 * ```
 */
export declare function isConvertToSharesSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeConvertToShares(options: ConvertToSharesParams): `0xc6e6f592${string}`;
/**
