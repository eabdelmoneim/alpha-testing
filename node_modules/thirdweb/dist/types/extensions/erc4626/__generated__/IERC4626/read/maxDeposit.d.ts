 ...
 * ```
 */
export declare function isMaxDepositSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeMaxDeposit(options: MaxDepositParams): `0x402d267d${string}`;
/**
