 ...
 * ```
 */
export declare function isPreviewMintSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodePreviewMint(options: PreviewMintParams): `0xb3d7f6b9${string}`;
/**
