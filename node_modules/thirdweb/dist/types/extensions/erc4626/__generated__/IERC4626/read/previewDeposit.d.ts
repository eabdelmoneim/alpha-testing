 ...
 * ```
 */
export declare function isPreviewDepositSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodePreviewDeposit(options: PreviewDepositParams): `0xef8b30f7${string}`;
/**
