 ...
 * ```
 */
export declare function isGetMetadataUriSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetMetadataUri(options: GetMetadataUriParams): `0xf4c2012d${string}`;
/**
