 ...
 * ```
 */
export declare function isUnpublishContractSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeUnpublishContract(options: UnpublishContractParams): `0x06eb56cc${string}`;
/**
