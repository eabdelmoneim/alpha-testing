 ...
 * ```
 */
export declare function isGetPublishedContractSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPublishedContract(options: GetPublishedContractParams): `0x7ec047fa${string}`;
/**
