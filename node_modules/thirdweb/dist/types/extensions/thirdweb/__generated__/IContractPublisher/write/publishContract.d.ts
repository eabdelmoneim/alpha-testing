 ...
 * ```
 */
export declare function isPublishContractSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodePublishContract(options: PublishContractParams): `0xd50299e6${string}`;
/**
