 ...
 * ```
 */
export declare function isSetPublisherProfileUriSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetPublisherProfileUri(options: SetPublisherProfileUriParams): `0x6e578e54${string}`;
/**
