 ...
 * ```
 */
export declare function isGetPublishedUriFromCompilerUriSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPublishedUriFromCompilerUri(options: GetPublishedUriFromCompilerUriParams): `0x819e992f${string}`;
/**
