 ...
 * ```
 */
export declare function isGetPublisherProfileUriSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetPublisherProfileUri(options: GetPublisherProfileUriParams): `0x4f781675${string}`;
/**
