 ...
 * ```
 */
export declare function isGetFeeInfoSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetFeeInfo(options: GetFeeInfoParams): `0x85b49ad0${string}`;
/**
