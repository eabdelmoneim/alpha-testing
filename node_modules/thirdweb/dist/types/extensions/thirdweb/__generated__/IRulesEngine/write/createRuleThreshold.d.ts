 ...
 * ```
 */
export declare function isCreateRuleThresholdSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCreateRuleThreshold(options: CreateRuleThresholdParams): `0x1022a25e${string}`;
/**
