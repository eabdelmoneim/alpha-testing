 ...
 * ```
 */
export declare function isCreateRuleMultiplicativeSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCreateRuleMultiplicative(options: CreateRuleMultiplicativeParams): `0x1e2e9cb5${string}`;
/**
