 ...
 * ```
 */
export declare function isGetScoreSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetScore(options: GetScoreParams): `0xd47875d0${string}`;
/**
