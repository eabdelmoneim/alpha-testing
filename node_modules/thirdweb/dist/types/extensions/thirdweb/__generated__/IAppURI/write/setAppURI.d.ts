 ...
 * ```
 */
export declare function isSetAppURISupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetAppURI(options: SetAppURIParams): `0xfea18082${string}`;
/**
