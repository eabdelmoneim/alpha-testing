 ...
 * ```
 */
export declare function isSetContractURISupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetContractURI(options: SetContractURIParams): `0x938e3d7b${string}`;
/**
