 ...
 * ```
 */
export declare function isBuySupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBuy(options: BuyParams): `0x7687ab02${string}`;
/**
