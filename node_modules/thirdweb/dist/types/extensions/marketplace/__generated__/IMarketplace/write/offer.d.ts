 ...
 * ```
 */
export declare function isOfferSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeOffer(options: OfferParams): `0x5fef45e7${string}`;
/**
