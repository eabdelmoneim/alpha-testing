 ...
 * ```
 */
export declare function isSetPlatformFeeInfoSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeSetPlatformFeeInfo(options: SetPlatformFeeInfoParams): `0x1e7ac488${string}`;
/**
