 ...
 * ```
 */
export declare function isMakeOfferSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeMakeOffer(options: MakeOfferParams): `0x016767fa${string}`;
/**
