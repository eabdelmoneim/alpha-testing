 ...
 * ```
 */
export declare function isGetAllOffersSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAllOffers(options: GetAllOffersParams): `0xc1edcfbe${string}`;
/**
