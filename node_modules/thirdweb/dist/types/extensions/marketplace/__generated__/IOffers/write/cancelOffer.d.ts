 ...
 * ```
 */
export declare function isCancelOfferSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCancelOffer(options: CancelOfferParams): `0xef706adf${string}`;
/**
