 ...
 * ```
 */
export declare function isGetAllValidOffersSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidOffers(options: GetAllValidOffersParams): `0x91940b3e${string}`;
/**
