 ...
 * ```
 */
export declare function isAcceptOfferSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAcceptOffer(options: AcceptOfferParams): `0xc815729d${string}`;
/**
