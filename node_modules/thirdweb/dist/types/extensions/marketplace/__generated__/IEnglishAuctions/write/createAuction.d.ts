 ...
 * ```
 */
export declare function isCreateAuctionSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCreateAuction(options: CreateAuctionParams): `0x16654d40${string}`;
/**
