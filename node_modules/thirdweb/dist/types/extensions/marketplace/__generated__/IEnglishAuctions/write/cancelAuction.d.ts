 ...
 * ```
 */
export declare function isCancelAuctionSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCancelAuction(options: CancelAuctionParams): `0x96b5a755${string}`;
/**
