 ...
 * ```
 */
export declare function isIsNewWinningBidSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeIsNewWinningBid(options: IsNewWinningBidParams): `0x2eb566bd${string}`;
/**
