 ...
 * ```
 */
export declare function isCollectAuctionPayoutSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCollectAuctionPayout(options: CollectAuctionPayoutParams): `0xebf05a62${string}`;
/**
