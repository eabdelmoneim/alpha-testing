 ...
 * ```
 */
export declare function isGetAllValidAuctionsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidAuctions(options: GetAllValidAuctionsParams): `0x7b063801${string}`;
/**
