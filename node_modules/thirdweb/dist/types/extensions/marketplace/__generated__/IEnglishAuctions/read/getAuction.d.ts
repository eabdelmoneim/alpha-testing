 ...
 * ```
 */
export declare function isGetAuctionSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAuction(options: GetAuctionParams): `0x78bd7935${string}`;
/**
