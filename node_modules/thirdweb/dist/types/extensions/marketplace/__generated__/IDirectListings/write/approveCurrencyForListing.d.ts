 ...
 * ```
 */
export declare function isApproveCurrencyForListingSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeApproveCurrencyForListing(options: ApproveCurrencyForListingParams): `0xea8f9a3c${string}`;
/**
