 ...
 * ```
 */
export declare function isGetListingSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetListing(options: GetListingParams): `0x107a274a${string}`;
/**
