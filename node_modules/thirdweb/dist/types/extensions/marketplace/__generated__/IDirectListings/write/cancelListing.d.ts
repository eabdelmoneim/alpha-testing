 ...
 * ```
 */
export declare function isCancelListingSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeCancelListing(options: CancelListingParams): `0x305a67a8${string}`;
/**
