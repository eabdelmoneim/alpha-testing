 ...
 * ```
 */
export declare function isGetAllValidListingsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidListings(options: GetAllValidListingsParams): `0x31654b4d${string}`;
/**
