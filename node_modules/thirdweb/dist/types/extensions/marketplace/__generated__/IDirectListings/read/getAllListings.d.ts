 ...
 * ```
 */
export declare function isGetAllListingsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeGetAllListings(options: GetAllListingsParams): `0xc5275fb0${string}`;
/**
