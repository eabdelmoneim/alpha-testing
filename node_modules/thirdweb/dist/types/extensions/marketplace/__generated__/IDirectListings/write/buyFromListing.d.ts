 ...
 * ```
 */
export declare function isBuyFromListingSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeBuyFromListing(options: BuyFromListingParams): `0x704232dc${string}`;
/**
