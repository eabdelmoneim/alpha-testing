 ...
 * ```
 */
export declare function isAddrSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeAddr(options: AddrParams): `0x3b3b57de${string}`;
/**
