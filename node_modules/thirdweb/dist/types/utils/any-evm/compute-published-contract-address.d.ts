 ...
 */
export declare function computePublishedContractAddress(args: {
 ...
 * @internal
 */
export declare function computeContractAddress(args: {
    client: ThirdwebClient;
    chain: Chain;
    contractMetadata: FetchDeployMetadataResult;
    constructorParams: unknown[];
}): Promise<string>;
//# sourceMappingURL=compute-published-contract-address.d.ts.map