...
export declare const DEFAULT_TOKEN_DURATION_SECONDS: number;
 ...
 *
 */
export declare function generateJWT(options: AuthOptions): (params: GenerateJWTParams) => Promise<string>;
export {};
//# sourceMappingURL=generate-jwt.d.ts.map