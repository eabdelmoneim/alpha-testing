...
export declare const ethers5Adapter: {
    provider: {
         ...
         * ```
         */
        toEthers: (client: ThirdwebClient, chain: Chain) => ethers5.ethers.providers.Provider;
    };
    contract: {
        /**
         ...
         * ```
         */
        toEthers: (twContract: ThirdwebContract) => Promise<ethers5.ethers.Contract>;
        /**
    ...
    signer: {
         ...
         * ```
         */
        fromEthers: (signer: ethers5.Signer) => Promise<Account>;
        /**
         ...
         * ```
         */
        toEthers: (client: ThirdwebClient, account: Account) => Promise<{
            ...
            sendTransaction(transaction: ethers5.ethers.utils.Deferrable<ethers5.ethers.providers.TransactionRequest & {
                chainId: number;
