 ...
 * @internal
 */
export declare function prepareInfraContractDeployTransaction(options: GetDeployedInfraParams): import("../../../transaction/prepare-transaction.js").PreparedTransaction<[], import("abitype").AbiFunction>;
