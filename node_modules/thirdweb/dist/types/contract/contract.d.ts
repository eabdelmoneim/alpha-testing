...
export type ThirdwebContract<abi extends Abi = []> = Readonly<ContractOptions<abi>>;
/**
 ...
 * @contract
 */
export declare function getContract<const abi extends Abi = []>(options: ContractOptions<abi>): ThirdwebContract<abi>;
