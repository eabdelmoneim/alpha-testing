 ...
 * @internal
 */
export declare function connectWC(options: WCConnectOptions, emitter: WalletEmitter<WCSupportedWalletIds>): Promise<ReturnType<typeof onConnect>>;
/**
 * Auto connect to already connected wallet connect session.
 * @internal
 */
export declare function autoConnectWC(options: WCAutoConnectOptions, emitter: WalletEmitter<WCSupportedWalletIds>): Promise<ReturnType<typeof onConnect>>;
