...
export declare const markAccountDeploying: (accountContract: ThirdwebContract) => void;
export declare const clearAccountDeploying: (accountContract: ThirdwebContract) => void;
export declare const isAccountDeploying: (accountContract: ThirdwebContract) => boolean;
/**
