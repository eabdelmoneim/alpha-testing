...
export type PreparedTransaction<abi extends Abi = [], abiFn extends AbiFunction = AbiFunction> = Readonly<PrepareTransactionOptions> & {
 ...
 * ```
 */
export declare function prepareTransaction<const abi extends Abi = [], const abiFn extends AbiFunction = AbiFunction>(options: PrepareTransactionOptions, info?: Additional<abi, abiFn>): PreparedTransaction<abi, abiFn>;
export {};
