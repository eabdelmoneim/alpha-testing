import { parseAbi, formatAbi } from "abitype";
 ...
 * @contract
 */
export async function resolveAbiFromContractApi(contract, contractApiBaseUrl = "https://contract.thirdweb.com/abi") {
 ...
 * @contract
 */
export async function resolveAbiFromBytecode(contract) {
...
export async function resolveCompositeAbi(contract, rootAbi, resolveSubAbi) {
    const [rootAbi_, pluginPatternAddresses, baseRouterAddresses, diamondFacetAddresses,] = await Promise.all([
