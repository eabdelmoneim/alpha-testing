...
import { getBuyWithCryptoHistory, } from "../../../../pay/buyWithCrypto/actions/getHistory.js";
/**
 ...
 * @buyCrypto
 */
export function useBuyWithCryptoHistory(buyWithCryptoHistoryParams, queryParams) {
    return useQuery({
        ...queryParams,
