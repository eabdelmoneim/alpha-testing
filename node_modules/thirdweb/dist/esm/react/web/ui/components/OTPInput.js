...
export function OTPInput(props) {
    ...
    return (_jsx(Container, { center: "x", gap: "sm", flex: "row", children: new Array(props.digits).fill(null).map((_, i) => {
            return (_jsx(OTPInputBox, { "data-error": props.isInvalid, ref: (e) => (boxEls.current[i] = e), value: otp[i] ?? "", type: "text", pattern: "[a-zA-Z0-9]*", variant: "outline", inputMode: "text", onPaste: (e) => {
