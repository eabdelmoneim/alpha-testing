...
export function ModalHeader(props) {
    ...
    return (_jsxs("div", { style: {
            ...
            position: "relative",
                    ...
                    left: 0,
                    top: 0,
                } })), _jsxs(Container, { flex: "row", gap: "xs", center: "both", children: [imgSrc && (_jsx(Img, { src: imgSrc, width: iconSize.md, height: iconSize.md })), typeof title === "string" ? _jsx(ModalTitle, { children: title }) : title] })] }));
}
...
export function Container(props) {
    ...
    return (_jsx(Box, { "data-scrolly": props.scrollY, "data-animate": props.animate, color: props.color, style: {
            ...styles,
            ...props.style,
