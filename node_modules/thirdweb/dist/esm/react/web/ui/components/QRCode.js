...
export const QRCode = (props) => {
    ...
    return (_jsxs("div", { style: {
        ...
        }, children: [props.qrCodeUri ? (_jsx(Suspense, { fallback: placeholder, children: _jsx(QRCodeContainer, { children: _jsx(QRCodeRenderer, { uri: props.qrCodeUri, size: size + 20, ecl: "M", clearSize: props.QRIcon ? 70 : undefined }) }) })) : (placeholder), props.QRIcon && _jsx(IconContainer, { children: props.QRIcon })] }));
};
