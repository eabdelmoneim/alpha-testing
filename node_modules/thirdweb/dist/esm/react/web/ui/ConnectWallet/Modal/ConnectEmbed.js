...
const ConnectEmbedContent = (props) => {
    ...
    if (isAutoConnecting) {
        ...
        content = (_jsx(ConnectModalContent, { shouldSetActive: true, screenSetup: screenSetup, isOpen: true, onClose: () => {
            ...
            // TODO: no welcome screen for embed right now?
            // welcomeScreen={undefined}
            welcomeScreen: undefined, isEmbed: props.isEmbed, onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets: props.wallets, modalHeader: undefined, walletIdsToHide: undefined }));
    }
