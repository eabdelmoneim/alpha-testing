...
export function AnyWalletConnectUI(props) {
    ...
    if (props.wallet.id === "inApp" || props.wallet.id === "embedded") {
        return (_jsx(Suspense, { fallback: _jsx(LoadingScreen, {}), children: _jsx(InAppWalletConnectUI, { wallet: props.wallet, done: props.done, goBack: props.onBack, chain: props.chain, client: props.client, size: props.size, connectLocale: props.connectLocale, meta: props.meta }) }));
    }
