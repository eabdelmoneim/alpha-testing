...
export function BuyTokenInput(props) {
    ...
    return (_jsxs(Container, { children: [_jsx("div", { onClick: (e) => {
                    e.currentTarget.querySelector("input")?.focus();
                        ...
                        flexWrap: "nowrap",
                    }, children: [_jsx(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", placeholder: "0", type: "text", "data-placeholder": props.value === "", value: props.value || "0", onClick: (e) => {
                            ...
                            }, gap: "xxs", onClick: props.onSelectToken, children: [_jsxs(Container, { flex: "row", center: "y", gap: "sm", children: [_jsx(TokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), _jsxs(Container, { flex: "column", style: {
                                                gap: "4px",
                                            }, children: [_jsx(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), chainQuery.data?.name ? (_jsx(Text, { size: "xs", color: "secondaryText", children: chainQuery.data.name })) : (_jsx(Skeleton, { width: "90px", height: fontSize.xs }))] })] }), _jsx(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
                                        marginLeft: "auto",
                                    } })] }) })] }))] }));
}
