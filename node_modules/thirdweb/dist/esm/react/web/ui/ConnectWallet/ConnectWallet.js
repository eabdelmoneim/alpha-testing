...
import { useSetIsWalletModalOpen, SetModalConfigCtx, WalletUIStatesProvider, } from "../../providers/wallet-ui-states-provider.js";
...
export function ConnectButton(props) {
    ...
    return (_jsx(WalletConnectionContext.Provider, { value: {
        ...
        }, children: _jsxs(WalletUIStatesProvider, { theme: "dark", children: [_jsx(ConnectButtonInner, { ...props, connectLocale: locale }), _jsx(ConnectModal, {}), autoConnectComp] }) }));
}
...
function SwitchNetworkButton(props) {
    ...
    return (_jsx(AnimatedButton, { className: `${TW_CONNECT_WALLET}--switch-network ${props.className || ""}`, variant: "primary", type: "button", "data-is-loading": switching, "data-test": "switch-network-button", disabled: switching, onClick: async () => {
            setSwitching(true);
            try {
