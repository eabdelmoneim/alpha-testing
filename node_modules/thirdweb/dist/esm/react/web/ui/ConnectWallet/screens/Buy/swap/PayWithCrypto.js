...
export function PayWithCrypto(props) {
    ...
    return (_jsxs(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
            ...
            minHeight: "64px",
            alignItems: "center",
        }, children: [_jsxs(TokenButton, { variant: "secondary", onClick: props.onSelectToken, children: [_jsx(TokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), _jsxs(Container, { flex: "column", gap: "xxs", children: [_jsxs(Container, { flex: "row", gap: "xs", center: "y", children: [_jsx(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), _jsx(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] }), chainQuery.data?.name ? (_jsxs(Text, { size: "xs", children: [" ", chainQuery.data.name] })) : (_jsx(Skeleton, { width: "90px", height: fontSize.xs }))] })] }), _jsxs("div", { style: {
                    flexGrow: 1,
                    flexShrink: 1,
                    display: "flex",
