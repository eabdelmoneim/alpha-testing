...
function RenderTokenInfo(props) {
    ...
    return (_jsxs(Container, { flex: "column", gap: "xxs", style: {
            alignItems: "flex-end",
        }, children: [_jsxs(Container, { flex: "row", center: "y", gap: "xs", children: [_jsxs(Text, { color: "primaryText", size: "md", children: [props.amount, " ", props.symbol] }), _jsx(PayTokenIcon, { token: props.token, chain: props.chain, size: "sm", client: props.client })] }), name ? (_jsx(Text, { size: "sm", children: name })) : (_jsx(Skeleton, { width: "100px", height: fontSize.sm }))] }));
}
