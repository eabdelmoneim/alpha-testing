...
export function WalletSelector(props) {
    ...
    if (personalWallet) {
        return (_jsx(SmartConnectUI, { accountAbstraction: props.accountAbstraction, done: props.done, personalWallet: personalWallet, setModalVisibility: props.setModalVisibility, onBack: props.goBack, meta: props.meta, size: props.size, chain: props.chain, chains: props.chains, client: props.client, walletConnect: props.walletConnect, connectLocale: props.connectLocale }));
    }
...
const WalletSelectorInner = (props) => {
    ...
    const twTitle = props.modalHeader ? (_jsx(ModalHeader, { title: props.modalHeader.title, onBack: props.modalHeader.onBack })) : (_jsxs(Container, { gap: "xxs", center: "y", flex: "row", children: [!props.meta.titleIconUrl ? null : (_jsx(Img, { src: props.meta.titleIconUrl, width: iconSize.md, height: iconSize.md, client: props.client })), _jsxs(ModalTitle, { children: [" ", props.title, " "] })] }));
            ...
            if (!isWalletGroupExpanded) {
                ...
                // social login + eoa wallets
                    ...
                    // social login + single eoa wallet
                        ...
                        bottomSection = (_jsxs(_Fragment, { children: [_jsx(Container, { px: "lg", children: _jsx(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets }) }), continueAsGuest && (_jsx(Container, { flex: "column", px: "lg", gap: "lg", children: continueAsGuest })), tos ? (_jsxs(_Fragment, { children: [continueAsGuest ? _jsx(Spacer, { y: "md" }) : _jsx(Line, {}), _jsxs(Container, { p: "md", children: [" ", tos, " "] })] })) : (_jsx(_Fragment, { children: continueAsGuest && _jsx(Spacer, { y: "xl" }) }))] }));
                    }
                }
            }
            // expanded state
    ...
    return (_jsxs(Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
        ...
        }, children: [showHeader && (_jsx(Container, { p: "lg", children: isWalletGroupExpanded ? (_jsx(ModalHeader, { title: twTitle, onBack: () => {
                        setIsWalletGroupExpanded(false);
                    } })) : (twTitle) })), _jsxs(Container, { expand: true, scrollY: true, px: "md", style: !showHeader
                    ? {
                        paddingTop: spacing.lg,
                    }
                    : {
                        paddingTop: "2px",
                    }, children: [!props.modalHeader && props.isEmbed && isWalletGroupExpanded && (_jsx(Container, { flex: "row", center: "y", style: {
                            padding: spacing.sm,
                            paddingTop: 0,
