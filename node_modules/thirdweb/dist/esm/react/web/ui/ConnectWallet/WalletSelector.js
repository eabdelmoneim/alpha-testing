...
const WalletSelectorInner = (props) => {
    ...
    const twTitle = (_jsxs(Container, { gap: "xxs", center: "y", flex: "row", children: [connectModal.titleIcon === undefined ? (_jsx(Link, { color: "primaryText", hoverColor: "accentText", target: "_blank", href: "https://thirdweb.com/connect?utm_source=cw", style: {
                    display: "flex",
                    alignItems: "center",
                }, onClick: (e) => {
                ...
                }, children: _jsx(TWIcon, { size: iconSize.md }) })) : connectModal.titleIcon === "" ? null : (_jsx(Img, { src: connectModal.titleIcon, width: iconSize.md, height: iconSize.md, client: client })), _jsxs(ModalTitle, { children: [" ", props.title, " "] })] }));
    ...
    const connectAWallet = (_jsxs(Button, { fullWidth: true, variant: "outline", style: {
        ...
        }, children: [_jsx(Container, { flex: "row", gap: "xxs", children: eoaWallets.slice(0, 2).map((w) => (_jsx(WalletImage, { id: w.id, size: iconSize.sm, client: client }, w.id))) }), locale.connectAWallet] }));
    ...
    return (_jsxs(Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
        ...
        }, children: [!isEmbed && (_jsx(Container, { p: "lg", style: {
                    paddingBottom: spacing.md,
