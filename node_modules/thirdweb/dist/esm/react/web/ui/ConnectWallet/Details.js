...
import { ChevronRightIcon, ExitIcon, 
// EnterIcon,
PaperPlaneIcon, PinBottomIcon, PlusIcon, TextAlignJustifyIcon, } from "@radix-ui/react-icons";
...
// useConnect,
useDisconnect, useSwitchActiveWalletChain, } from "../../../core/hooks/wallets/wallet-hooks.js";
...
export const ConnectedWalletDetails = (props) => {
    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xl" }), _jsxs(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
                        ...
                        }, client: client })) : activeWallet?.id ? (_jsx(WalletImage, { size: iconSize.xxl, id: activeWallet.id, client: client })) : (_jsx(WalletIcon, { size: iconSize.xxl })), _jsx(Spacer, { y: "md" }), _jsxs("div", { style: {
                            display: "flex",
                            gap: spacing.xxs,
                            alignItems: "center",
