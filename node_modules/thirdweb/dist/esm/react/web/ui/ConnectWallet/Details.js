    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xs" }), _jsxs(Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
                    ...
                    paddingBottom: hideAllButtons ? spacing.md : spacing.lg,
                                ...
                                gap: spacing.xs,
                                        ...
                                        setScreen("receive");
                                    }, children: [_jsxs(Container, { color: "secondaryText", flex: "row", center: "both", children: [_jsx(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }), " "] }), locale.receive, " "] })), !hideBuyFunds && (_jsxs(Button, { variant: "outline", style: {
                                        fontSize: fontSize.sm,
                                        display: "flex",
                                        gap: spacing.xs,
                                        alignItems: "center",
