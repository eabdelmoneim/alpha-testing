...
export const ConnectedWalletDetails = (props) => {
    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xl" }), _jsxs(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
                        ...
                        }, client: client })) : activeWallet?.id ? (_jsx(WalletImage, { size: iconSize.xxl, id: activeWallet.id, client: client, allowOverrides: true })) : (_jsx(WalletIcon, { size: iconSize.xxl })), _jsx(Spacer, { y: "md" }), _jsx(ConnectedToSmartWallet, {}), (activeWallet?.id === "embedded" || activeWallet?.id === "inApp") && (_jsx(InAppWalletUserInfo, {})), _jsxs("div", { style: {
                            display: "flex",
                            gap: spacing.xxs,
                            alignItems: "center",
    ...
    // swap tokens
        ...
        content = (_jsx(BuyScreen, { client: client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, onViewPendingTx: () => setScreen("pending-tx"), connectLocale: locale }));
    }
