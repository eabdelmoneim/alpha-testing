...
function DetailsModal(props) {
    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xl" }), _jsx(IconButton, { style: {
                    ...
                    setScreen("wallet-manager");
                }, children: _jsx(ShuffleIcon, { width: iconSize.md, height: iconSize.md }) }), _jsxs(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
                        ...
                        gap: spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(CoinsIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: props.supportedNFTs ? "View Assets" : "View Funds" })] }), _jsxs(MenuButton, { onClick: () => {
    ...
    if (screen === "network-switcher") {
        ...
        if (props.supportedNFTs) {
            content = (_jsx(ViewFunds, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
                    setScreen("main");
