 ...
 * @internal
 */
export const GetStartedScreen = ({ wallet, walletInfo, header, footer, onBack, locale }) => {
    ...
    return (_jsx(Container, { fullHeight: true, flex: "column", animate: "fadein", children: _jsxs(Container, { expand: true, flex: "column", p: "lg", children: [showScreen === "android-scan" && walletInfo.app.android && (_jsx(InstallScanScreen, { platformIcon: _jsx(PlayStoreIcon, { size: iconSize.md }), url: walletInfo.app.android, platform: "Google Play", walletName: walletInfo.name, walletId: wallet.id, onBack: handleBack, locale: {
                    ...
                    } })), showScreen === "ios-scan" && walletInfo.app.ios && (_jsx(InstallScanScreen, { platformIcon: _jsx(AppleIcon, { size: iconSize.md }), url: walletInfo.app.ios, platform: "App Store", walletName: walletInfo.name, walletId: wallet.id, onBack: handleBack, locale: {
                        scanToDownload: locale.getStartedScreen.instruction,
                    } })), showScreen === "base" && (_jsxs(Container, { expand: true, flex: "column", children: [header || (_jsx(ModalHeader, { onBack: handleBack, title: walletInfo.name })), _jsx(Spacer, { y: "xl" }), _jsx(Container, { expand: true, animate: "fadein", flex: "column", center: "y", style: {
                                minHeight: "250px",
...
const InstallScanScreen = (props) => {
    return (_jsxs(Container, { animate: "fadein", expand: true, children: [_jsx(ModalHeader, { title: props.walletName, onBack: props.onBack }), _jsx(Spacer, { y: "xl" }), _jsxs(Container, { flex: "column", expand: true, center: "both", style: {
                    textAlign: "center",
                }, children: [_jsx(QRCode, { qrCodeUri: props.url, QRIcon: _jsx(WalletImage, { id: props.walletId, size: iconSize.xxl }) }), _jsx(Spacer, { y: "xl" }), _jsx(Text, { multiline: true, center: true, balance: true, children: props.locale.scanToDownload }), _jsx(Spacer, { y: "xs" })] })] }));
};
