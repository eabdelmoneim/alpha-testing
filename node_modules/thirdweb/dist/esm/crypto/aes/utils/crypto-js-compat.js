...
import { base64ToUint8Array, concatUint8Arrays, } from "../../../utils/uint8-array.js";
 ...
 * @internal
 */
export async function decryptCryptoJSCipherBase64(salt, ciphertext, password, { keySizeDWORD = 256 / 32, ivSizeDWORD = 128 / 32, iterations = 1 } = {}) {
 ...
 * @internal
 */
export function parseCryptoJSCipherBase64(cryptoJSCipherBase64) {
    let salt = null;
