            ...
            const wallet = {
                ...
                autoConnect: async (options) => {
                    ...
                    if (options && "client" in options) {
                        ...
                        const [connectedAccount, connectedChain, doDisconnect, doSwitchChain,] = await autoConnectWC(options, emitter);
                        // set the states
                        account = connectedAccount;
                        chain = connectedChain;
                        handleDisconnect = doDisconnect;
                ...
                connect: async (options) => {
                    ...
                    if (options && "walletConnect" in options) {
                        ...
                        const [connectedAccount, connectedChain, doDisconnect, doSwitchChain,] = await connectWC(options, emitter);
                        // set the states
                        account = connectedAccount;
                        chain = connectedChain;
                        handleDisconnect = doDisconnect;
 ...
 * @wallet
 */
export function embeddedWallet(createOptions) {
    const emitter = createWalletEmitter();
    let account = undefined;
    let chain = undefined;
    return {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
            const { autoConnectEmbeddedWallet } = await import("./embedded/core/wallet/index.js");
        ...
        connect: async (options) => {
            const { connectEmbeddedWallet } = await import("./embedded/core/wallet/index.js");
