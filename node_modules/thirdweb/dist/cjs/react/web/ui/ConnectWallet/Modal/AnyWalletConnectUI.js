...
const EmbeddedWalletConnectUI = /* @__PURE__ */ (0, react_1.lazy)(() => Promise.resolve().then(() => require("../../../wallets/embedded/EmbeddedWalletConnectUI.js")));
/**
 * @internal
 */
function AnyWalletConnectUI(props) {
    ...
    if (props.wallet.id === "embedded") {
        return ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, {}), children: (0, jsx_runtime_1.jsx)(EmbeddedWalletConnectUI, { wallet: props.wallet, done: props.done, goBack: props.onBack }) }));
    }
