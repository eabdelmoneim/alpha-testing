...
const ConnectModalContent = (props) => {
    ...
    const { wallets, accountAbstraction } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    const { onConnect, connectModal, connectLocale } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
