...
const connectionManager_js_1 = require("../../../../core/connectionManager.js");
...
function SmartWalletConnecting(props) {
    ...
    const handleConnect = (0, react_1.useCallback)(async () => {
        ...
        try {
            const connected = await (0, connectionManager_js_1.connectionManagerSingleton)(webStorage_js_1.webLocalStorage).handleConnection(personalWallet, {
