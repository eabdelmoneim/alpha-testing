...
exports.WalletEntryButton = void 0;
...
function WalletEntryButton(props) {
    ...
    const { connectLocale, recommendedWallets } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    const isRecommended = recommendedWallets?.find((w) => w === wallet);
    const { screen } = (0, screen_js_1.useScreenContext)();
    const walletInfo = (0, useWalletInfo_js_1.useWalletInfo)(wallet.id);
    const walletName = (0, mipdStore_js_1.getMIPDStore)()
        .getProviders()
