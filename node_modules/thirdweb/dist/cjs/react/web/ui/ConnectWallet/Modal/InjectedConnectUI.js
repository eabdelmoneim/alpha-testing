...
const asyncLocalStorage_js_1 = require("../../../../core/utils/asyncLocalStorage.js");
/**
 * @internal
 */
const InjectedConnectUI = (props) => {
    const { wallet, done } = props;
    const { chain } = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)();
    ...
    const connectToExtension = (0, react_1.useCallback)(async () => {
        try {
            ...
            wallet.setStorage?.(asyncLocalStorage_js_1.asyncLocalStorage);
