...
function SwapConfirmationScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Buy", onBack: props.onBack }), props.isFiatFlow ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(StepBar_js_1.StepBar, { steps: 2, currentStep: 2 }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { size: "xs", children: ["Step 2 of 2 - Converting ", props.fromTokenSymbol, " to", " ", props.toTokenSymbol] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" })] })) : ((0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })), (0, jsx_runtime_1.jsx)(ConfirmItem, { label: "Pay", children: (0, jsx_runtime_1.jsx)(RenderTokenInfo, { chain: props.fromChain, amount: String((0, formatNumber_js_1.formatNumber)(Number(props.fromAmount), 6)), symbol: props.fromTokenSymbol || "", token: props.fromToken, client: props.client }) }), (0, jsx_runtime_1.jsx)(ConfirmItem, { label: "Receive", children: (0, jsx_runtime_1.jsx)(RenderTokenInfo, { chain: props.toChain, amount: String((0, formatNumber_js_1.formatNumber)(Number(props.toAmount), 6)), symbol: props.toTokenSymbol, token: props.toToken, client: props.client }) }), (0, jsx_runtime_1.jsx)(ConfirmItem, { label: "Fees", children: (0, jsx_runtime_1.jsx)(Fees_js_1.SwapFees, { quote: props.quote, align: "right" }) }), (0, jsx_runtime_1.jsx)(ConfirmItem, { label: "Time", children: (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", children: ["~", (0, formatSeconds_js_1.formatSeconds)(props.quote.swapDetails.estimated.durationSeconds || 0)] }) }), receiver !== sender && ((0, jsx_runtime_1.jsx)(ConfirmItem, { label: "Send to", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: (0, address_js_1.shortenAddress)(receiver) }) })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), isApprovalRequired && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { gap: "sm", flex: "row", style: {
                            justifyContent: "space-between",
                        }, center: "y", color: "accentText", children: [(0, jsx_runtime_1.jsx)(Stepper_js_1.Step, { isDone: step === "swap", isActive: step === "approval", label: step === "approval" ? "Approve" : "Approved" }), (0, jsx_runtime_1.jsx)(ConnectorLine, {}), (0, jsx_runtime_1.jsx)(Stepper_js_1.Step, { isDone: false, label: "Confirm", isActive: step === "swap" })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })), status === "error" && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, jsx_runtime_1.jsx)(react_icons_1.CrossCircledIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "danger", size: "sm", children: step === "approval" ? "Failed to Approve" : "Failed to Confirm" })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" })] })), props.payer.chain.id !== props.fromChain.id ? ((0, jsx_runtime_1.jsx)(SwitchNetwork_js_1.SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
...
function RenderTokenInfo(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", style: {
            alignItems: "flex-end",
        }, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", gap: "xs", children: [(0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "md", children: [props.amount, " ", props.symbol] }), (0, jsx_runtime_1.jsx)(PayTokenIcon_js_1.PayTokenIcon, { token: props.token, chain: props.chain, size: "sm", client: props.client })] }), name ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: name })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_1.fontSize.sm }))] }));
}
