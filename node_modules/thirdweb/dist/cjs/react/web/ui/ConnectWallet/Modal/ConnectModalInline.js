...
function ConnectModalInlineContent(props) {
    ...
    const content = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ConnectModalContent_js_1.ConnectModalContent, { screenSetup: screenSetup, onHide: () => {
                    // no op
                }, isOpen: true, onClose: () => {
                    // no op
                }, onShow: () => {
