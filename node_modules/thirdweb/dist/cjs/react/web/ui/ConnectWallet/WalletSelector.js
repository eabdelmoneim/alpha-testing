...
const WalletSelectorInner = (props) => {
    ...
    const connectAWallet = ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: props.client, icon: socialIcons_js_1.genericWalletIcon, onClick: () => {
    ...
    const tos = props.meta.termsOfServiceUrl || props.meta.privacyPolicyUrl ? ((0, jsx_runtime_1.jsx)(TOS_js_1.TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement })) : undefined;
    let topSection;
    let bottomSection;
    // wide modal
    if (!isCompact) {
            ...
            if (!isWalletGroupExpanded) {
                ...
                // social login + eoa wallets
                    ...
                    // social login + single eoa wallet
                        ...
                        bottomSection = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsx)(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets }) }), continueAsGuest && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", px: "lg", gap: "lg", children: continueAsGuest })), tos ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [continueAsGuest ? (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }) : (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "md", children: [" ", tos, " "] })] })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: continueAsGuest && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }) }))] }));
                    }
                }
            }
            // expanded state
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
            maxHeight: props.size === "compact" ? constants_js_1.compactModalMaxHeight : undefined,
                    ...
                    : {
                        paddingTop: "2px",
                    }, children: [!props.modalHeader && props.isEmbed && isWalletGroupExpanded && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "y", style: {
