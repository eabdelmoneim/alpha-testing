...
const WalletSelector = (props) => {
    ...
    const eoaWallets = (0, sortWallets_js_1.sortWallets)(nonLocalWalletConfigs.filter((w) => w.id !== embeddedWalletId), recommendedWallets);
...
const WalletSelection = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(WalletList, { style: {
            minHeight: "100%",
                ...
                return ((0, jsx_runtime_1.jsx)("li", { children: wallet.id === "embedded" && modalSize === "compact" ? ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, { height: "195px" }), children: (0, jsx_runtime_1.jsx)(EmbeddedWalletSelectionUI, { done: () => props.done(wallet), select: () => props.selectWallet(wallet), wallet: wallet, goBack: props.goBack }) })) : ((0, jsx_runtime_1.jsx)(WalletEntryButton_js_1.WalletEntryButton, { walletId: wallet.id, selectWallet: () => {
                            props.selectWallet(wallet);
                        } })) }, wallet.id));
