...
const WalletSelector = (props) => {
    ...
    const twTitle = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { gap: "xxs", center: "y", flex: "row", children: [connectModal.titleIcon === undefined ? ((0, jsx_runtime_1.jsx)(text_js_1.Link, { color: "primaryText", hoverColor: "accentText", target: "_blank", href: "https://thirdweb.com/connect?utm_source=cw", style: {
                    display: "flex",
                    alignItems: "center",
                }, onClick: (e) => {
                ...
                }, children: (0, jsx_runtime_1.jsx)(twIcon_js_1.TWIcon, { size: index_js_1.iconSize.md }) })) : connectModal.titleIcon === "" ? null : ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: connectModal.titleIcon, width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, client: client })), (0, jsx_runtime_1.jsxs)(modalElements_js_1.ModalTitle, { children: [" ", props.title, " "] })] }));
    ...
    const connectAWallet = ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { fullWidth: true, variant: "outline", style: {
        ...
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xxs", children: eoaWallets.slice(0, 2).map((w) => ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: w.id, size: index_js_1.iconSize.sm, client: client }, w.id))) }), locale.connectAWallet] }));
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
        ...
        }, children: [!isEmbed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", style: {
                    paddingBottom: index_js_1.spacing.md,
