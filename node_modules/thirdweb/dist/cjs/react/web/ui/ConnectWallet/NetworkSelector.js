...
function NetworkSelectorContentInner(props) {
    ...
    const locale = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)().connectLocale.networkSelector;
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: props.onBack ? ((0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: locale.title, onBack: props.onBack })) : ((0, jsx_runtime_1.jsx)(modalElements_js_1.ModalTitle, { children: locale.title })) }), props.showTabs !== false && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xxs", children: [(0, jsx_runtime_1.jsx)(TabButton, { onClick: () => setSelectedTab("all"), "data-active": selectedTab === "all", children: locale.allNetworks }), (0, jsx_runtime_1.jsx)(TabButton, { onClick: () => setSelectedTab("mainnet"), "data-active": selectedTab === "mainnet", children: locale.mainnets }), (0, jsx_runtime_1.jsx)(TabButton, { onClick: () => setSelectedTab("testnet"), "data-active": selectedTab === "testnet", children: locale.testnets })] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })), props.showTabs === false && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsxs)("div", { style: {
                        ...
                        position: "relative",
                            ...
                            }, children: (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "md", color: "accentText" }) }))] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", children: (0, jsx_runtime_1.jsx)(NetworkTabContent, { allChainIds: allChainsToShow, popularChainIds: popularChainsToShow, recentChainIds: recentChainsToShow, onSwitch: handleSwitch, renderChain: props.networkSelector?.renderChain }) }), onCustomClick && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, variant: "link", onClick: () => {
                                onCustomClick();
                            }, style: {
                                display: "flex",
...
const NetworkTabContent = (props) => {
    const locale = (0, useWalletConnectionCtx_js_1.useWalletConnectionCtx)().connectLocale.networkSelector.categoryLabel;
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, animate: "fadein", style: {
        ...
        }, children: [recentChainIds && recentChainIds.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(SectionLabel, { children: locale.recentlyUsed }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(NetworkList, { chains: recentChainIds, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })), popularChainIds && popularChainIds.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(SectionLabel, { children: locale.popular }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(NetworkList, { chains: popularChainIds, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] })), ((popularChainIds && popularChainIds.length > 0) ||
                (recentChainIds && recentChainIds.length > 0)) && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(SectionLabel, { children: locale.others }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" })] })), (0, jsx_runtime_1.jsx)(NetworkList, { chains: allChainIds, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close }), noChainsToShow && ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsx)(react_icons_1.CrossCircledIcon, { width: index_js_1.iconSize.xl, height: index_js_1.iconSize.xl }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { children: " No Results " })] }))] }));
};
const NetworkList = /* @__PURE__ */ (0, react_1.memo)(function NetworkList(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(NetworkListUl, { children: chainsToShow.map((chain, i) => {
            ...
            return ((0, jsx_runtime_1.jsx)("li", { ref: isLast ? lastItemRef : undefined, children: RenderChain ? ((0, jsx_runtime_1.jsx)(RenderChain, { switchChain: () => {
                        handleSwitch(chain);
                    }, chain: chain, switching: switchingChainId === chain.id, switchFailed: errorSwitchingChainId === chain.id, close: props.close })) : ((0, jsx_runtime_1.jsx)(exports.ChainButton, { chain: chain, confirming: confirming, onClick: () => handleSwitch(chain), switchingFailed: switchingFailed })) }, chain.id));
        }) }));
});
exports.ChainButton = (0, react_1.memo)(function ChainButton(props) {
    ...
    const activeChain = (0, wallet_hooks_js_1.useActiveWalletChain)();
    const apiChainQuery = (0, useChainQuery_js_1.useChainQuery)(chain);
    const chainName = apiChainQuery.data ? ((0, jsx_runtime_1.jsxs)("span", { children: [apiChainQuery.data.name, " "] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "150px", height: "20px" }));
    return ((0, jsx_runtime_1.jsxs)(NetworkButton, { "data-active": activeChain?.id === chain.id, onClick: props.onClick, children: [apiChainQuery.data ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chain: apiChainQuery.data, size: index_js_1.iconSize.lg, active: activeChain?.id === chain.id, loading: "lazy" })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: index_js_1.iconSize.lg + "px", height: index_js_1.iconSize.lg + "px" })), confirming || switchingFailed ? ((0, jsx_runtime_1.jsxs)("div", { style: {
                    display: "flex",
