...
const chains_js_1 = require("../../../../exports/chains.js");
...
const ConnectedWalletDetails = (props) => {
    ...
    const ensNameQuery = (0, react_query_1.useQuery)({
        ...
        queryFn: () => (0, resolve_name_js_1.resolveName)({
            client,
            address: activeAccount?.address || "",
            resolverChain: chains_js_1.ethereum,
        }),
    });
    ...
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: chainQuery.data ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chain: chainQuery.data, size: index_js_2.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_2.iconSize.md, width: index_js_2.iconSize.md })) }), chainQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "200px" })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", multiline: true, children: chainQuery.data?.name || `Unknown chain #${walletChain?.id}` })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_2.iconSize.xxl, height: index_js_2.iconSize.xxl, style: {
                        ...
                        }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_2.iconSize.xxl, id: activeWallet.id, client: client })) : ((0, jsx_runtime_1.jsx)(WalletIcon_js_1.WalletIcon, { size: index_js_2.iconSize.xxl })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { width: index_js_2.iconSize.md, height: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }), pendingSwapTxs && pendingSwapTxs.length > 0 && ((0, jsx_runtime_1.jsx)(BadgeCount, { children: pendingSwapTxs.length }))] })] }), (props.detailsModal?.showTestnetFaucet ?? false) &&
    ...
    // swap tokens
        ...
        content = ((0, jsx_runtime_1.jsx)(SwapScreen_js_1.BuyScreen, { client: client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, onViewPendingTx: () => setScreen("pending-tx"), connectLocale: locale }));
    }
...
function InAppWalletEmail() {
    ...
    const emailQuery = (0, react_query_1.useQuery)({
        ...
        queryFn: async () => {
            const data = await (0, index_js_1.getUserEmail)({
                client: client,
            });
            return data || null;
        },
    ...
    if (emailQuery.data) {
        return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", style: {
                paddingBottom: index_js_2.spacing.md,
