...
const ConnectedWalletDetails = (props) => {
    ...
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: chainQuery.data ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chain: chainQuery.data, size: index_js_1.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.iconSize.md, width: index_js_1.iconSize.md })) }), chainQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "200px" })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", multiline: true, children: chainQuery.data?.name || `Unknown chain #${walletChain?.id}` })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.xxl, height: index_js_1.iconSize.xxl, style: {
                        ...
                        }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_1.iconSize.xxl, id: activeWallet.id, client: client, allowOverrides: true })) : ((0, jsx_runtime_1.jsx)(WalletIcon_js_1.WalletIcon, { size: index_js_1.iconSize.xxl })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(ConnectedToSmartWallet, {}), (activeWallet?.id === "embedded" || activeWallet?.id === "inApp") && ((0, jsx_runtime_1.jsx)(InAppWalletUserInfo, {})), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
