...
const useSwitchActiveWalletChain_js_1 = require("../../hooks/wallets/useSwitchActiveWalletChain.js");
...
function DetailsModal(props) {
                    ...
                    setScreen("wallet-manager");
                        ...
                        gap: index_js_1.spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: props.supportedNFTs ? "View Assets" : "View Funds" })] }), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
                                    setScreen("manage-wallet");
                                }, style: {
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(OutlineWalletIcon_js_1.OutlineWalletIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "Manage Wallet" })] }), (props.detailsModal?.showTestnetFaucet ?? false) &&
    ...
    if (screen === "pending-tx") {
        content = ((0, jsx_runtime_1.jsx)(BuyTxHistory_js_1.BuyTxHistory, { isBuyForTx: false, isEmbed: false, onBack: () => setScreen("main"), client: client, onDone: closeModal }));
    }
    ...
    if (screen === "network-switcher") {
        ...
        if (props.supportedNFTs) {
            content = ((0, jsx_runtime_1.jsx)(ViewFunds_js_1.ViewFunds, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
                    setScreen("main");
                }, setScreen: setScreen, client: client }));
        }
        else {
