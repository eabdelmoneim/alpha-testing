...
const index_js_2 = require("../../../../wallets/embedded/core/authentication/index.js");
...
function EmbeddedWalletEmail() {
    ...
    const emailQuery = (0, react_query_1.useQuery)({
        ...
        queryFn: async () => {
            return (0, index_js_2.getUserEmail)({
                client: client,
            });
        },
    });
