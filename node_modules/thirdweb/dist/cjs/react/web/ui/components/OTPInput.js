...
function OTPInput(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "x", gap: "sm", flex: "row", children: new Array(props.digits).fill(null).map((_, i) => {
            return ((0, jsx_runtime_1.jsx)(OTPInputBox, { "data-error": props.isInvalid, ref: (e) => (boxEls.current[i] = e), value: otp[i] ?? "", type: "text", pattern: "[a-zA-Z0-9]*", variant: "outline", inputMode: "text", onPaste: (e) => {
