...
function TokenSymbol(props) {
    if (!(0, nativeToken_js_1.isNativeToken)(props.token)) {
        return ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: props.size, color: "primaryText", children: props.token.symbol }));
    }
    return (0, jsx_runtime_1.jsx)(NativeTokenSymbol, { chain: props.chain, size: props.size });
}
...
function NativeTokenSymbol(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: props.size, color: "primaryText", children: data.nativeCurrency.symbol }));
}
