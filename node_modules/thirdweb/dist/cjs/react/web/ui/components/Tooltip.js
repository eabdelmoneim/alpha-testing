 ...
 */
const ToolTip = (props) => {
    return ((0, jsx_runtime_1.jsx)(RadixTooltip.Provider, { delayDuration: 200, children: (0, jsx_runtime_1.jsxs)(RadixTooltip.Root, { children: [(0, jsx_runtime_1.jsx)(RadixTooltip.Trigger, { asChild: true, children: props.children }), (0, jsx_runtime_1.jsx)(RadixTooltip.Portal, { children: (0, jsx_runtime_1.jsxs)(TooltipContent, { sideOffset: props.sideOffset || 6, align: props.align || "center", side: props.side || "top", children: [props.tip, (0, jsx_runtime_1.jsx)(TooltipArrow, {})] }) })] }) }));
};
...
`;
const TooltipContent = /* @__PURE__ */ (() => (0, styled_1.default)(RadixTooltip.Content)(() => {
