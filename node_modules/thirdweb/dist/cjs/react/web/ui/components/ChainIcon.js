...
exports.ChainIcon = exports.fallbackChainIcon = void 0;
...
const ChainIcon = (props) => {
    const getSrc = () => {
        ...
        if (!url) {
            return exports.fallbackChainIcon;
        }
        try {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            flexShrink: 0,
            alignItems: "center",
        }, children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: getSrc(), width: props.size, height: props.size, fallbackImage: exports.fallbackChainIcon, client: props.client }), props.active && (0, jsx_runtime_1.jsx)(ActiveDot, {})] }));
};
