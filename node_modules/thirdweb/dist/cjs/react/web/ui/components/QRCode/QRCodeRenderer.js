...
function QRCodeRenderer({ ecl = "M", size: sizeProp = 200, uri, clearSize = 0, image, imageBackground = "transparent", }) {
                    ...
                    if (!((i < 7 && j < 7) ||
                        ...
                        if (image ||
                            !(i > matrixMiddleStart &&
                                ...
                                j > matrixMiddleStart &&
                                j < matrixMiddleEnd)) {
                            dotsArray.push((0, jsx_runtime_1.jsx)("circle", { cx: i * cellSize + cellSize / 2, cy: j * cellSize + cellSize / 2, fill: "var(--ck-qr-dot-color)", r: cellSize / 3 }, `circle-${i}-${j}`));
                        }
                    }
                }
            });
    ...
    return ((0, jsx_runtime_1.jsxs)("svg", { height: size, width: size, viewBox: `0 0 ${size} ${size}`, style: {
            width: size,
            height: size,
        }, children: [(0, jsx_runtime_1.jsx)("rect", { fill: "transparent", height: size, width: size }), dots] }));
}
