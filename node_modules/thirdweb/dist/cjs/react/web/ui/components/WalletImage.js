...
function WalletImage(props) {
    const mipdImage = (0, mipdStore_js_1.getInstalledWalletProviders)().find((provider) => provider.info.rdns === props.id)?.info.icon;
    if (mipdImage) {
        return ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: mipdImage, width: props.size, height: props.size, loading: "eager", client: props.client, style: {
