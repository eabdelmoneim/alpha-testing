...
exports.isBaseTransactionOptions = void 0;
...
function isBaseTransactionOptions(value) {
    return ((0, type_guards_js_1.isObjectWithKeys)(value, ["contract"]) &&
        (0, type_guards_js_1.isObjectWithKeys)(value.contract, ["address", "chain"]) &&
