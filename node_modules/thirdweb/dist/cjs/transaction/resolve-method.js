...
function resolveMethod(method) {
    return async function (contract) {
        const resolvedAbi = await (0, resolve_abi_js_1.resolveContractAbi)(contract);
...
//# sourceMappingURL=resolve-method.js.map