...
exports.isValidChainIdAndContractAddress = exports.generate = void 0;
...
async function generate(input) {
    ...
    const contract = (0, contract_js_1.getContract)({
        client,
        chain: (0, utils_js_1.defineChain)(parseInt(chainId)),
...
*/\n\n`;
    ...
    const prettified = await (0, prettier_1.format)(body, {
        parser: "babel-ts",
    });
    return prettified;
}
