...
exports.uploadBatchMobile = void 0;
const domains_js_1 = require("../../utils/domains.js");
const fetch_js_1 = require("../../utils/fetch.js");
const helpers_js_1 = require("./helpers.js");
const METADATA_NAME = "Storage React Native SDK";
function uploadBatchMobile(client, data, options) {
    ...
    if (typeof data[0] === "object" &&
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                const res = await fetch(`https://${(0, domains_js_1.getThirdwebDomains)().storage}/ipfs/batch-pin-json`, {
                    method: "POST",
                    headers: {
                        ...(client.clientId ? { "x-client-id": client.clientId } : {}),
                        "Content-Type": "application/json",
                        ...(0, fetch_js_1.getPlatformHeaders)(),
                    },
                    body: fetchBody,
                });
                if (res.ok) {
