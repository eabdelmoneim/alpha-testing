...
exports.replaceObjectGatewayUrlsWithSchemes = exports.replaceObjectFilesWithUris = exports.extractObjectFiles = exports.isFileOrUint8Array = exports.buildFormData = exports.isFileBufferOrStringEqual = void 0;
...
function isFileBufferOrStringEqual(input1, input2) {
    if (isFileInstance(input1) && isFileInstance(input2)) {
        ...
        if (input1.name === input2.name) {
            ...
            else if ((0, uint8_array_js_1.isUint8Array)(input1.data) && (0, uint8_array_js_1.isUint8Array)(input2.data)) {
