...
exports.generateJWT = exports.DEFAULT_TOKEN_DURATION_SECONDS = void 0;
const encode_jwt_js_1 = require("../../utils/jwt/encode-jwt.js");
exports.DEFAULT_TOKEN_DURATION_SECONDS = 60 * 60 * 24;
/**
            ...
            payload: {
                ...
                exp: new Date(now +
                    (options.jwt?.expirationTimeSeconds ||
                        exports.DEFAULT_TOKEN_DURATION_SECONDS) *
                        1000),
                iat: new Date(),
