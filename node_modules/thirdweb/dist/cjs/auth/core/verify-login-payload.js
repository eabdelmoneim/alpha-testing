...
exports.verifyLoginPayload = void 0;
...
function verifyLoginPayload(options) {
    return async function ({ payload, signature, }) {
        ...
        const signatureIsValid = await (0, verifySignature_js_1.verifySignature)({
            message: computedMessage,
            signature: signature,
            address: payload.address,
            chain: payload.chain_id
                ? (0, utils_js_1.defineChain)(parseInt(payload.chain_id))
                : undefined,
