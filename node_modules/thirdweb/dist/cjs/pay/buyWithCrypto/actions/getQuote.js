...
async function getBuyWithCryptoQuote(params) {
    try {
        ...
        const url = `${(0, definitions_js_1.getPayBuyWithCryptoQuoteEndpoint)()}?${queryString}`;
        ...
        const swapRoute = {
            transactionRequest: {
                chain: (0, utils_js_1.defineChain)(data.transactionRequest.chainId),
            ...
            approval: data.approval
                ? (0, approve_js_1.approve)({
                    contract: (0, contract_js_1.getContract)({
                        ...
                        chain: (0, utils_js_1.defineChain)(data.approval.chainId),
                    }),
