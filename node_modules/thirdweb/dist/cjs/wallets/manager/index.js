...
exports.getStoredActiveWalletId = exports.getStoredConnectedWalletIds = exports.createConnectionManager = void 0;
...
function createConnectionManager(storage) {
    ...
    const setActiveWallet = (wallet) => {
        ...
        const unsubAccounts = wallet.subscribe("accountsChanged", onAccountsChanged);
