...
exports.isAccountDeploying = exports.clearAccountDeploying = exports.markAccountDeploying = void 0;
...
exports.markAccountDeploying = markAccountDeploying;
...
exports.isAccountDeploying = isAccountDeploying;
/**
...
async function populateUserOp_v0_7(args) {
    ...
    if (isDeployed || (0, exports.isAccountDeploying)(accountContract)) {
        factoryData = "0x";
        ...
        (0, exports.markAccountDeploying)(accountContract);
    }
    const partialOp = {
...
async function waitForAccountDeployed(accountContract) {
    ...
    while ((0, exports.isAccountDeploying)(accountContract)) {
