...
exports.getThirdwebDomains = exports.setThirdwebDomains = exports.DEFAULT_RPC_URL = void 0;
...
const setThirdwebDomains = (DomainOverrides) => {
    domains = {
        ...
        embeddedWallet: DomainOverrides.embeddedWallet ?? DEFAULT_EMBEDDED_WALLET_URL,
